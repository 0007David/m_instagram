...
(function (root) {
	...
	Protected.prototype = {
		...
		messages: {
		    ...
		    en: {
		        required: {
		            empty: 'Este es un campo requerido',
		        ...
		        integer: {
		            empty: 'Ingrese un valor número entero',
		            incorrect: 'Valor número entero incorrecto'
		        },
		        float: {
		            empty: 'Ingrese un número con decimal',
		            incorrect: 'Número con decimal iIncorrecto'
		        },
		        min: {
		            empty: 'Ingrese mas caracteres',
		            incorrect: 'Ingrese mas caracteres'
		        },
		        max: {
		            empty: 'Ingrese menos caracteres',
		            incorrect: 'Ingrese menos caracteres'
		        },
		        between: {
		            empty: 'Ingrese valores entre {0}-{1}',
		            incorrect: 'Ingrese valores entre {0}-{1}'
		        },
		        name: {
		        ...
		        lastname: {
		            empty: 'Por favor, enter your lastname',
		            incorrect: 'Incorrect lastname'
		        },
		        phone: {
		            empty: 'Por favor, ingrese su número de celular',
		            incorrect: 'Número de celular incorrecto'
		        },
		        email: {
		            empty: 'Por favor, ingrese su correo electrónico',
		        ...
		        minlength: {
		            empty: 'Por favor, ingrese un mínimo de {0} caracteres',
		            incorrect: 'Ha ingresado menos de {0} caracteres'
		        },
		        maxlength: {
		            empty: 'Por favor, ingrese un máximo de {0} caracteres',
		            incorrect: 'Ha ingresado nayor de {0} caracteres'
		        },
		        maxfilesize: {
